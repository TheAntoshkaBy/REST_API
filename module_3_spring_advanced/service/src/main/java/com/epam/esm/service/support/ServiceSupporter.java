...
public class ServiceSupporter {
    ...
    public static List<CertificatePOJO> convertCertificateEntityToCertificatePOJO(List<Certificate> certificates){
       return certificates.stream()
               .map(CertificatePOJO::new)
               .collect(Collectors.toList());
   }

    public static List<CertificateOrderPOJO> convertOrderEntityToOrderCertificatePOJO(List<CertificateOrder> orders){
