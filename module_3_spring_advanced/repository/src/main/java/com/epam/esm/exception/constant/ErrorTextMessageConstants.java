...
public class ErrorTextMessageConstants {
    ...
    public static final String NOT_FOUND_ORDER = "Order with given id does not exist, enter another id";
    public static final String NOT_FOUND_TAG = "Tag with given id does not exist, enter another id";
    public static final String NOT_FOUND_USER = "User with given id does not exist, enter another id";
