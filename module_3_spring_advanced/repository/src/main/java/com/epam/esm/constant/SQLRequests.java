...
public class SQLRequests {
    ...
    public static final String FIND_ALL_CERTIFICATES_WITH_LIMIT_OFFSET = "select c "
        + "from certificate c order by c.id";

    public static final String FIND_ALL_ORDERS_WITH_LIMIT_OFFSET = "select o "
    ...
    public static final String ADD_NEW_TAG_TO_CERTIFICATE_TRANSACTION = "DO $$\n" +
        ...
        "tag_id_to_set int;\n" +
        "BEGIN\n" +
        "INSERT INTO rest_api_basics.tag (tag_name, id_tag) "
        + "VALUES (:tag_name, DEFAULT) RETURNING id_tag INTO tag_id_to_set;\n"
        +
        "INSERT INTO rest_api_basics.many_certificates_to_many_tags "
        + "VALUES (:id_certificate, tag_id_to_set);\n"
        +
        "COMMIT;\n" +
        "END $$";
}
