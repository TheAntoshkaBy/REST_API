...
import com.epam.esm.repository.jpa.JPACertificateRepository;
...
@Transactional
@Repository
public class CertificateJPQLJPARepository extends ShopJPARepository<Certificate> implements JPACertificateRepository { //fixme попробовать с проперти SQLRequest
