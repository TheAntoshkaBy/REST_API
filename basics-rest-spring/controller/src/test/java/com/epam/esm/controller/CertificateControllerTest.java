...
public class CertificateControllerTest {
    ...
    public void findCertificate_CertificateId_ResponseEntityWithCertificateWhichContainTransmittedId() {
        ...
        actualResponseEntity = certificateController.findCertificate(13);
    ...
    @Test
    public void sortedCertificatesByDate_AllCertificatesListSortedByDate() {
        when(service.findAllCertificatesSortedByDate()).thenReturn(expectedCertificates);
        actualResponseEntity = certificateController.sortedCertificatesByDate();
        expectedResponseEntity = new ResponseEntity<>(expectedCertificates, HttpStatus.OK);
        Assert.assertEquals(expectedResponseEntity,actualResponseEntity);
    }

    @Test
    public void certificatesWhereIdMoreThanParameterId_Id_AllCertificatesWhereIdMoreThatTransmittedParameter() {
        when(service.findAllCertificateWhereIdCountMoreThenParameterCount(anyInt())).thenReturn(expectedCertificates);
        actualResponseEntity = certificateController.certificatesWhereIdMoreThanParameterId(anyInt());
        expectedResponseEntity = new ResponseEntity<>(expectedCertificates, HttpStatus.OK);
        Assert.assertEquals(expectedResponseEntity,actualResponseEntity);
    }

    @Test
    public void addCertificate_NewCertificate_ListCertificatesWhichContainNewCertificate() {
        doAnswer(invocation -> {
    ...
    @Test
    public void updateCertificate_NewCertificateData_ListCertificatesWhichContainCertificateWithNewData() {
        doAnswer(invocation -> {
            Object certificateId = invocation.getArgument(0);
    ...
    public void findByTag_Tag_CertificatesWhichContainsTransmittedTag() {
        when(service.findAllCertificatesWhichContainsParameterTag(any(Tag.class))).thenReturn(expectedCertificates);
